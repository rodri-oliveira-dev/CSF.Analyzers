...
public sealed class Rel002ProhibitFireAndForgetInRequestFlowAnalyzerTests
{
...
""";
    ...
    {
        return Verifier<Rel002ProhibitFireAndForgetInRequestFlowAnalyzer>.VerifyAnalyzerAsync(source, expected);
    }

    private static DiagnosticResult Expected(int location, string usage)
    {
        return Verifier<Rel002ProhibitFireAndForgetInRequestFlowAnalyzer>.Diagnostic("REL002")
