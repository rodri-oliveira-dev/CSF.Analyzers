...
public sealed class Arc005AvoidDuplicatedMsBuildPropertiesAnalyzerTests
{
...
dotnet_diagnostic.ARC005.ignored_properties = ["Nullable"]
""";
...
[*.csproj]
dotnet_diagnostic.ARC005.severity = warning
dotnet_diagnostic.ARC005.compare_values = false
""";
...
[*.csproj]
dotnet_diagnostic.ARC005.severity = warning
dotnet_diagnostic.ARC005.ignored_properties = ["TargetFramework",
""";
    ...
    private static Task VerifyAsync(
        ...
        params DiagnosticResult[] expected)
    {
        return Verifier<Arc005AvoidDuplicatedMsBuildPropertiesAnalyzer>.VerifyAnalyzerAsync(
            EmptySource,
            editorConfig,
            additionalFiles,
            expected);
...
""";
    ...
    {
        return Verifier<Arc005AvoidDuplicatedMsBuildPropertiesAnalyzer>.Diagnostic("ARC005")
