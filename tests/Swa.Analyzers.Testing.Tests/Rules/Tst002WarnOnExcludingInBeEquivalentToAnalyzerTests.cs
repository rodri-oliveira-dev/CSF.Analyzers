...
public sealed class Tst002WarnOnExcludingInBeEquivalentToAnalyzerTests
{
    [Fact]
...
""";
        ...
        var expected = Verifier<Tst002WarnOnExcludingInBeEquivalentToAnalyzer>.Diagnostic("TST002")
            .WithLocation(0)
            .WithArguments("Excluding")
            .WithMessage("Avoid using 'Excluding' in BeEquivalentTo() options. Exclusions can reduce test precision.");

        await Verifier<Tst002WarnOnExcludingInBeEquivalentToAnalyzer>.VerifyAnalyzerAsync(source, expected);
    }
...
""";
        ...
        var excluding = Verifier<Tst002WarnOnExcludingInBeEquivalentToAnalyzer>.Diagnostic("TST002")
            .WithLocation(0)
            .WithArguments("Excluding")
            .WithMessage("Avoid using 'Excluding' in BeEquivalentTo() options. Exclusions can reduce test precision.");

        var excludingMissingMembers = Verifier<Tst002WarnOnExcludingInBeEquivalentToAnalyzer>.Diagnostic("TST002")
            .WithLocation(1)
            .WithArguments("ExcludingMissingMembers")
            .WithMessage("Avoid using 'ExcludingMissingMembers' in BeEquivalentTo() options. Exclusions can reduce test precision.");

        var excludingNestedObjects = Verifier<Tst002WarnOnExcludingInBeEquivalentToAnalyzer>.Diagnostic("TST002")
            .WithLocation(2)
        ...
        await Verifier<Tst002WarnOnExcludingInBeEquivalentToAnalyzer>.VerifyAnalyzerAsync(
            source,
            excluding,
...
""";
        ...
        await Verifier<Tst002WarnOnExcludingInBeEquivalentToAnalyzer>.VerifyAnalyzerAsync(source);
    }
