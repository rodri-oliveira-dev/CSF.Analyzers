...
public sealed class Rel004AvoidPrematureQueryMaterializationAnalyzerTests
{
...
""";
    ...
    {
        return Verifier<Rel004AvoidPrematureQueryMaterializationAnalyzer>.VerifyAnalyzerAsync(
            (new[]
            {
    ...
    {
        return Verifier<Rel004AvoidPrematureQueryMaterializationAnalyzer>.Diagnostic("REL004")
