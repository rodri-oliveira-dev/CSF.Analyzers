...
public sealed class Rel003PreferAsNoTrackingForReadOnlyQueriesAnalyzerTests
{
...
""";
    ...
    {
        return Verifier<Rel003PreferAsNoTrackingForReadOnlyQueriesAnalyzer>.VerifyAnalyzerAsync(
            (new[]
            {
    ...
    {
        return Verifier<Rel003PreferAsNoTrackingForReadOnlyQueriesAnalyzer>.Diagnostic("REL003")
