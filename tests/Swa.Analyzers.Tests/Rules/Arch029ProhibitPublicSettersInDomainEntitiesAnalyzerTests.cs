...
public sealed class Arch029ProhibitPublicSettersInDomainEntitiesAnalyzerTests
{
    [Fact]
...
[*.cs]
dotnet_diagnostic.ARCH029.entity_namespaces = ["MyApp.Model"]
""";
...
[*.cs]
dotnet_diagnostic.ARCH029.entity_base_types = ["DomainEntity"]
""";
...
[*.cs]
dotnet_diagnostic.ARCH029.allow_internal_setters = true
""";
...
""";
    ...
    {
        return Verifier<Arch029ProhibitPublicSettersInDomainEntitiesAnalyzer>.VerifyAnalyzerAsync(source, editorConfig, expected);
    }

    private static DiagnosticResult Expected(int location, string propertyName)
    {
        return Verifier<Arch029ProhibitPublicSettersInDomainEntitiesAnalyzer>.Diagnostic("ARCH029")
