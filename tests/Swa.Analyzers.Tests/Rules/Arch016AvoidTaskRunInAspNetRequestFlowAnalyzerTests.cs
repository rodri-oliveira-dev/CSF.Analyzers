...
public sealed class Arch016AvoidTaskRunInAspNetRequestFlowAnalyzerTests
{
...
""";
    ...
    {
        return Verifier<Arch016AvoidTaskRunInAspNetRequestFlowAnalyzer>.VerifyAnalyzerAsync(source, expected);
    }

    private static DiagnosticResult Expected(int location, string usage)
    {
        return Verifier<Arch016AvoidTaskRunInAspNetRequestFlowAnalyzer>.Diagnostic("ARCH016")
