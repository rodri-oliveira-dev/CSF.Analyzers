...
public sealed class Arc003ProhibitVerbsInHttpRoutesAnalyzerTests
{
...
dotnet_diagnostic.ARC003.route_language = en-US
""";
...
dotnet_diagnostic.ARC003.severity = warning
dotnet_diagnostic.ARC003.route_language = pt-BR
dotnet_diagnostic.ARC003.additional_verbs = ["arquivar"]
""";
...
""";
        ...
        await Verifier<Arc003ProhibitVerbsInHttpRoutesAnalyzer>.VerifyAnalyzerAsync(
            [
...
[*.cs]
dotnet_diagnostic.ARC003.severity = warning
dotnet_diagnostic.ARC003.route_language = es-ES
""";
...
dotnet_diagnostic.ARC003.severity = warning
dotnet_diagnostic.ARC003.route_language = en-US
dotnet_diagnostic.ARC003.additional_verbs = ["archive", "  publish  ", ""]
""";
...
dotnet_diagnostic.ARC003.severity = warning
dotnet_diagnostic.ARC003.route_language = en-US
dotnet_diagnostic.ARC003.additional_verbs = ["archive",
""";
...
dotnet_diagnostic.ARC003.severity = warning
dotnet_diagnostic.ARC003.route_language = pt-BR
dotnet_diagnostic.ARC003.additional_verbs = ["create"]
""";
...
""";
    ...
    {
        return Verifier<Arc003ProhibitVerbsInHttpRoutesAnalyzer>.VerifyAnalyzerAsync(source, editorConfig, expected);
    }

    private static DiagnosticResult Expected(int location, string segment, string verb, string language)
    {
        return Verifier<Arc003ProhibitVerbsInHttpRoutesAnalyzer>.Diagnostic("ARC003")
