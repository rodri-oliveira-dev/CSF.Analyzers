# REL002: Evite fire-and-forget em fluxo de request
...
- `Task.Run(...)` em fluxo de request também pode ser reportado por [REL001](REL001.md), que cobre o uso de `Task.Run` nesse contexto mesmo quando ele é aguardado ou retornado.
