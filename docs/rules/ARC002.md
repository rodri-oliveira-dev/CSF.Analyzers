# ARC002: Evite dependências de infraestrutura em camadas core
...
```ini
[*.cs]
dotnet_diagnostic.ARC002.core_namespace_patterns = Company.Product.Application
dotnet_diagnostic.ARC002.forbidden_namespace_patterns = "System.Net.Http;Microsoft.EntityFrameworkCore;Npgsql"
```
