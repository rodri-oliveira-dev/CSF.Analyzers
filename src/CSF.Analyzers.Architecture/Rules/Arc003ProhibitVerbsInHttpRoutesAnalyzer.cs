...
public sealed class Arc003ProhibitVerbsInHttpRoutesAnalyzer : DiagnosticAnalyzer
{
    private const string Category = "Design";
    private const string DefaultLanguage = "en-US";
    private const string PortugueseBrazilLanguage = "pt-BR";
    private const string RouteLanguageOption = "dotnet_diagnostic.ARC003.route_language";
    private const string AdditionalVerbsOption = "dotnet_diagnostic.ARC003.additional_verbs";
