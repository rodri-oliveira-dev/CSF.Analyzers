...
public sealed class Arc005AvoidDuplicatedMsBuildPropertiesAnalyzer : DiagnosticAnalyzer
{
    private const string Category = "Maintainability";
    private const string IgnoredPropertiesOption = "dotnet_diagnostic.ARC005.ignored_properties";
    private const string CompareValuesOption = "dotnet_diagnostic.ARC005.compare_values";
...
#pragma warning disable RS1013 // ARC005 inspeciona intencionalmente AdditionalFiles MSBuild uma vez ao fim da compilação.
