...
public sealed class Arch020RequireExplicitAuthorizationOnHttpEndpointsAnalyzer : DiagnosticAnalyzer
{
    private const string Category = "Security";
    private const string AllowedRoutesOption = "dotnet_diagnostic.ARCH020.allowed_routes";
    private const string AllowedMethodsOption = "dotnet_diagnostic.ARCH020.allowed_methods";
    private const string IgnoredNamespacesOption = "dotnet_diagnostic.ARCH020.ignored_namespaces";
