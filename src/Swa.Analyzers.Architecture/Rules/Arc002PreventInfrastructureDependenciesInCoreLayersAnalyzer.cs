...
public sealed class Arc002PreventInfrastructureDependenciesInCoreLayersAnalyzer : DiagnosticAnalyzer
{
    private const string Category = "Architecture";
    private const string CoreNamespacePatternsOption = "dotnet_diagnostic.ARC002.core_namespace_patterns";
    private const string ForbiddenNamespacePatternsOption = "dotnet_diagnostic.ARC002.forbidden_namespace_patterns";
    private const string AllowedNamespacePatternsOption = "dotnet_diagnostic.ARC002.allowed_namespace_patterns";
    private const string IgnoreTestsOption = "dotnet_diagnostic.ARC002.ignore_tests";
